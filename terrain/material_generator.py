source = [
	...
	['Brass', 0.329412, 0.223529, 0.027451, 1, 0.780392, 0.568627, 0.113725, 1, 0.992157, 0.941176, 0.807843, 1, 27.8974],
	['Bronze', 0.2125, 0.1275, 0.054, 1, 0.714, 0.4284, 0.18144, 1, 0.393548, 0.271906, 0.166721, 1, 25.6],
	['Polished Bronze', 0.25, 0.148, 0.06475, 1, 0.4, 0.2368, 0.1036, 1, 0.774597, 0.458561, 0.200621, 1, 76.8],
	['Chrome', 0.25, 0.25, 0.25, 1, 0.4, 0.4, 0.4, 1, 0.774597, 0.774597, 0.774597, 1, 76.8],
	['Copper', 0.19125, 0.0735, 0.0225, 1, 0.7038, 0.27048, 0.0828, 1, 0.256777, 0.137622, 0.086014, 1, 12.8],
	['Polished Copper', 0.2295, 0.08825, 0.0275, 1, 0.5508, 0.2118, 0.066, 1, 0.580594, 0.223257, 0.0695701, 1, 51.2],
	['Gold', 0.24725, 0.1995, 0.0745, 1, 0.75164, 0.60648, 0.22648, 1, 0.628281, 0.555802, 0.366065, 1, 51.2],
	['Polished Gold', 0.24725, 0.2245, 0.0645, 1, 0.34615, 0.3143, 0.0903, 1, 0.797357, 0.723991, 0.208006, 1, 83.2],
	['Pewter', 0.105882, 0.058824, 0.113725, 1, 0.427451, 0.470588, 0.541176, 1, 0.333333, 0.333333, 0.521569, 1, 9.84615],
	['Silver', 0.19225, 0.19225, 0.19225, 1, 0.50754, 0.50754, 0.50754, 1, 0.508273, 0.508273, 0.508273, 1, 51.2],
	['Polished Silver', 0.23125, 0.23125, 0.23125, 1, 0.2775, 0.2775, 0.2775, 1, 0.773911, 0.773911, 0.773911, 1, 89.6],
	...
	['Pearl', 0.25, 0.20725, 0.20725, 0.922, 1, 0.829, 0.829, 0.922, 0.296648, 0.296648, 0.296648, 0.922, 11.264],
	...
	['Black Plastic', 0, 0, 0, 1, 0.01, 0.01, 0.01, 1, 0.5, 0.5, 0.5, 1, 32],
	['Black Rubber', 0.02, 0.02, 0.02, 1, 0.01, 0.01, 0.01, 1, 0.4, 0.4, 0.4, 1, 10],
]

for s in source:
	if len(s) == 11:
		name, ax, ay, az, dx, dy, dz, sx, sy, sz, shininess = s
		shininess *= 128
	elif len(s) == 14:
		name, ax, ay, az, _, dx, dy, dz, _, sx, sy, sz, _, shininess = s
	else:
		print(s)
	...
	print({
		...
		'mass': 1.0,
		'render_model': 'blinn',
		'color_ambient': [ax, ay, ax, 1.0],
		'color_diffuse': [dx, dy, dz, 1.0],
		'color_specular': [sx, sy, sz, 1.0],
		'shininess': shininess,
	})