...
def MaterialStart(builder): builder.StartObject(7)
...
def MaterialAddColorDiffuse(builder, colorDiffuse): builder.PrependStructSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(colorDiffuse), 0)
def MaterialAddColorSpecular(builder, colorSpecular): builder.PrependStructSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(colorSpecular), 0)
def MaterialAddShininess(builder, shininess): builder.PrependFloat32Slot(6, shininess, 0.0)
