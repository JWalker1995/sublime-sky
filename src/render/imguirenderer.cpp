...
ImguiRenderer::ImguiRenderer(game::GameContext &context)
    : TickableBase(context)
{
    GLFWwindow *glfwWindow = context.get<application::Window>().getGlfwWindow();
...
void ImguiRenderer::tickOpen(game::TickerContext &tickerContext) {
    tickerContext.get<application::Window::Ticker>();
...
void ImguiRenderer::tickClose(game::TickerContext &tickerContext) {
    ImGui::Render();
